      ...
      <div className="task-three-container">
        ...
        <div className="left-content">
          ...
          <p>
            ...
            <input
              type="checkbox"
              style={{ marginLeft: "320px", marginTop: "10px" }}
            />
          </p>

          <h3 style={{ fontSize: "30px", color: "black", marginTop: "2px" }}>
            Applications will close on the<br></br> 15th December 2017.
            <input
              type="checkbox"
              name=""
              id=""
        ...
        <div className="right-form">
          <form>
            ...
            <p style={{ fontSize: "12.5px", marginTop: "10px" }}>
              (Please tick and provide details for all of the awards like to be
              nominated for)
            </p>
            ...
            <div className="award-item">
              <div style={{ display: "flex", flexDirection: "row" }}>
                ...
                <button id="bestTourCampaign" style={{ width: "15px" }}>
                  +
                </button>
              </div>
            ...
            <button type="submit" style={{ fontSize: "30px", color: "black" }}>
              {" "}
